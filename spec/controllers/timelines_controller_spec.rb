...
describe TimelinesController do
  ...
  let(:valid_attributes) { { "test_name" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved timeline as @timeline" do
        ...
        post :create, {:timeline => { "test_name" => "invalid value" }}, valid_session
        assigns(:timeline).should be_a_new(Timeline)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested timeline" do
        ...
        Timeline.any_instance.should_receive(:update_attributes).with({ "test_name" => "MyString" })
        put :update, {:id => timeline.to_param, :timeline => { "test_name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the timeline as @timeline" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Timeline.any_instance.stub(:save).and_return(false)
        put :update, {:id => timeline.to_param, :timeline => { "test_name" => "invalid value" }}, valid_session
        assigns(:timeline).should eq(timeline)
      end
