...
describe EnvironmentsController do
  ...
  let(:valid_attributes) { { "user_agent" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved environment as @environment" do
        ...
        post :create, {:environment => { "user_agent" => "invalid value" }}, valid_session
        assigns(:environment).should be_a_new(Environment)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested environment" do
        ...
        Environment.any_instance.should_receive(:update_attributes).with({ "user_agent" => "MyString" })
        put :update, {:id => environment.to_param, :environment => { "user_agent" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the environment as @environment" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Environment.any_instance.stub(:save).and_return(false)
        put :update, {:id => environment.to_param, :environment => { "user_agent" => "invalid value" }}, valid_session
        assigns(:environment).should eq(environment)
      end
